...
public class EnvelopeController {
    ...
    public PagedModel<EntityModel<EnvelopeResource>> listEnvelopes(
        ...
        var envelopeResources = envelopeService.listLedgerEnvelopes(userId(principal), ledgerSlug, pageable)
                .map(envelope -> toEntityModel(ledgerSlug, envelope, principal));

        return PagedModels.toPagedModel(envelopeResources,
    ...
    public EntityModel<EnvelopeResource> getEnvelope(
        ...
        final var envelope = envelopeService.find(userId(principal), ledgerSlug, envelopeId)
    ...
    public ResponseEntity<EntityModel<EnvelopeResource>> createEnvelope(
        ...
        Envelope createdEnvelope = envelopeService.create(userId(principal), ledgerSlug, request);
    ...
    public EntityModel<EnvelopeResource> updateEnvelope(
        ...
        Envelope updatedEnvelope = envelopeService.update(userId(principal), ledgerSlug, envelopeId, request);
    ...
    public ResponseEntity<Void> deleteEnvelope(
        ...
        envelopeService.delete(userId(principal), ledgerSlug, envelopeId);
    ...
    public ResponseEntity<EntityModel<EnvelopeAllocationResource>> allocate(
        ...
        EnvelopeAllocation allocation = envelopeService.allocate(userId(principal), ledgerSlug, envelopeId, request);
    ...
    public EntityModel<EnvelopeBalanceResource> getBalance(
        ...
        EnvelopeBalance balance = envelopeService.getBalance(userId(principal), ledgerSlug, envelopeId, year, month);
    ...
    public ResponseEntity<Map<String, List<String>>> getEnvelopeAccounts(
        ...
        List<String> accountIds = envelopeService.getEnvelopeAccounts(userId(principal), ledgerSlug, envelopeId);
    ...
    public ResponseEntity<Map<String, List<String>>> setEnvelopeAccounts(
        ...
        envelopeService.setEnvelopeAccounts(userId(principal), ledgerSlug, envelopeId, accountIds);
        return ResponseEntity.ok(Map.of("accountIds", accountIds));
    }
